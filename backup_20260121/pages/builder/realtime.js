...
export default function RealtimeBuilder() {
  const [projectId] = useState('realtime-demo')
  ...
  useEffect(() => {
    ...
    setProject(projectId, 'Real-time Collaboration Demo')
          ...
          <div className="flex justify-between items-center">
            <div>
                  ...
                  <span className="text-sm font-medium">
                    {socketConnected ? (
                      ...
                      <span className="text-red-500 flex items-center">
                        ...
                        OFFLINE - Socket server not running
                      </span>
                    )}
                  </span>
                </div>
              ...
              <p className="text-sm text-gray-600">
                {components.length} components • {socketConnected ? 'Changes sync in real-time' : 'Start socket server for collaboration'}
              </p>
            </div>
            ...
            <div className="flex">
              <div className="ml-3">
                <p className="text-sm text-yellow-700">
                  <strong>Socket server not running!</strong> Open a new Termux tab and run: <code className="bg-yellow-100 px-2 py-1 rounded">node socket-server.js</code>
                </p>
              </div>
            </div>
          </div>
