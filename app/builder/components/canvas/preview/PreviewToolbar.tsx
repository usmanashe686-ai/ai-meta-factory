...
export function PreviewToolbar({ device, onDeviceChange }: PreviewToolbarProps) {
  ...
  const handleRefresh = () => {
    ...
    // Force a refresh by toggling something in the preview iframe
    setTimeout(() => setIsRefreshing(false), 500);
  };

  const handleBuild = () => {
    setShowBuildPanel(true);
    triggerBuild('flutter'); // or let user choose platform
  };
    ...
    <>
      <div className="flex items-center justify-between px-4 py-2 border-b border-gray-200 bg-white dark:bg-gray-800 dark:border-gray-700">
        ...
        <div className="flex items-center space-x-2">
          ...
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 3v9a1 1 0 01-1 1h-4a1 1 0 01-1-1V7L8 4z" />
            </svg>
          </button>
