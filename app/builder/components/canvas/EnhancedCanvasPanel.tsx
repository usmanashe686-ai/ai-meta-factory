      ...
      <div className="max-w-6xl mx-auto">
        <header className="mb-12">
          ...
          <p className="text-gray-400">
            Full-stack application generated with AI
          </p>
        </header>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          <div className="bg-gray-800/50 backdrop-blur-sm p-6 rounded-xl border border-gray-700">
            ...
            <p className="text-gray-400 text-sm">
              Generated by advanced AI models with production-ready code
            </p>
          </div>
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm p-6 rounded-xl border border-gray-700">
            ...
            <p className="text-gray-400 text-sm">
              Built with Next.js, TypeScript, Tailwind CSS, and best practices
            </p>
          </div>
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm p-6 rounded-xl border border-gray-700">
            ...
            <p className="text-gray-400 text-sm">
              One-click deployment to Vercel, Netlify, or your own infrastructure
            </p>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-blue-900/30 to-purple-900/30 border border-blue-700/30 rounded-xl p-6">
          ...
          <p className="text-gray-300 mb-4">
            Edit this page in the code editor to customize your application.
            Use the AI Assistant to generate new components or features.
          </p>
          <div className="flex space-x-4">
            <button className="px-4 py-2 bg-blue-600 hover:bg-blue-700 rounded-lg">
              Explore Components
            </button>
            <button className="px-4 py-2 bg-gray-800 hover:bg-gray-700 border border-gray-700 rounded-lg">
              View Documentation
            </button>
          </div>
        </div>
